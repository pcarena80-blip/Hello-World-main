      ...
      <View className="px-6 pb-8">
        <View className="bg-white rounded-3xl p-6 shadow-sm">
          <View className="space-y-4">
            ...
            <View>
              ...
              <View className="relative">
                ...
                <TextInput
                  value={formData.cnic}
                  onChangeText={(text) =>
                    setFormData({ ...formData, cnic: text })
                  }
            ...
            {formData.propertyType === 'house' ? (
              <View className="flex-row gap-3">
                <View className="flex-1">
                  <Text className="text-gray-700 mb-2 text-xs font-medium">Block</Text>
                  <TextInput
            ...
            >
              <View className={`w-4 h-4 rounded border ${formData.agreeTerms ? 'bg-[#027A4C] border-[#027A4C]' : 'border-gray-300'}`} />
