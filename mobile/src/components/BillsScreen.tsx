...
export default function BillsScreen() {
  ...
  const upcomingBills = bills.filter((b: any) => b.status === 'due' || b.status === 'upcoming');
  const billHistory = bills.filter((b: any) => b.status === 'paid');
        ...
        <View className="mb-6">
          ...
          <View className="space-y-3">
            {upcomingBills.map((bill) => (
              <View key={bill.id} className="bg-white rounded-2xl p-5 shadow-sm">
        ...
        <View>
          ...
          <View className="space-y-3">
            {billHistory.map((bill) => (
              <View key={bill.id} className="bg-white rounded-2xl p-4 shadow-sm">
